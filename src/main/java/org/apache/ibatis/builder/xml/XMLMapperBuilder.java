...
public class XMLMapperBuilder extends BaseBuilder {
  ...
  private void configurationElement(XNode context) {
    try {
      ...
      parameterMapElement(context.evalNodes("/mappers/parameterMap"));
      resultMapElements(context.evalNodes("/mappers/resultMap"));
      sqlElement(context.evalNodes("/mappers/sql"));
